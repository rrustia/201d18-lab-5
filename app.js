...
function multiply(a,b){ //eslint-disable-line
  var answerArray = [];
  answerArray[0] = a * b;
  answerArray[1] = 'The product of ' + a + ' and ' + b + ' is ' + answerArray[0] + '.';
  return answerArray;
}
...
function sumArray(testArray){ //eslint-disable-line
  var sumTemp = [];
  sumTemp[0] = 0;
  var counter = testArray.length;
  for (var index = 0; index < counter; index++) {
    sumTemp = sum(sumTemp[0],testArray[index]);
  }
  return [sumTemp[0], testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' was passed in as an array of numbers, and ' + sumTemp[0] + ' is their sum.'];
}
